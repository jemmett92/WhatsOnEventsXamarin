...
namespace WhatOnEvents.Droid
{
    public class CredentialsProvider : ICredentialsProvider
    {
        ...
        public void Login(string userName, string password, Action successCallback,
            Action<LoginScreenFaultDetails> failCallback)
        {
        ...
        public void Register(string email, string userName, string password, Action successCallback,
            Action<LoginScreenFaultDetails> failCallback)
        {
